...
def build_manifest(
    ...
    return {
        ...
        "schema_version": "v1",
        "source_lineage": "Derived from Pike Postgres product tables filtered to strict interstate corridors.",
...
def main() -> None:
    ...
    with psycopg.connect(args.database_url) as conn:
        ...
        manifest = build_manifest(args.release_id, output_dir, written_files, row_counts)
